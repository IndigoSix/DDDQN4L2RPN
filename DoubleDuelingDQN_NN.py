...
class DoubleDuelingDQN_NN(object):
    ...
    def construct_q_network(self):
        ...
        #lay1 = tfk.layers.BatchNormalization()(lay1)
        ...
        #lay2 = tfk.layers.BatchNormalization()(lay2)
